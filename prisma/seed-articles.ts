...
const articles = [
  {
    ...
    content: `Po letech s Nette jsem se pustil do Next.js a tento web je můj učební i pracovní projekt zároveň.
...
Těším se, až tu přibudou reálné články, fotky ze zkoušek a třeba i ukázky z mixu.`,
  ...
  },
  {
    ...
    content: `Každý projekt začíná poslechem referencí a domluvou, jaký zvuk má výsledek mít. Teprve potom řeším úpravy a dynamiku.
...
V dalších článcích rozeberu konkrétní postupy — třeba práci s vokálem nebo přípravu materiálu před masteringem.`,
  ...
  },
  {
    ...
    content: `Největší změna oproti Nette je myšlení v komponentách a serverových akcích. Co dřív patřilo do presenteru, dnes rozděluji mezi stránky, layouty a server actions.
